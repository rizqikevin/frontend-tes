...
const SeksiCard: React.FC<SeksiCardProps> = ({
    ...
    return (
      <div className="w-44 bg-gray-100 border border-white shadow-md text-black">
        ...
        <div className="flex h-16">
          <div className="flex-1 bg-red-500 text-white font-bold text-xl flex items-center justify-center">
  ...
  return (
    <div className="w-44 bg-gray-100 border border-white shadow-md text-black">
      <div className="px-2 py-1 font-semibold text-sm text-center">{name}</div>
      <div className="flex h-16">
