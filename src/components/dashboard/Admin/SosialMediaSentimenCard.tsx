...
const SosialMediaSentimenCard: React.FC = () => {
  ...
  return (
    <div className="bg-dashboard-accent rounded-xl p-4 w-full text-white shadow">
      <div className="flex justify-between items-start mb-4">
        <div>
          <h2 className="font-semibold text-sm">Sosial Media Sentimen</h2>
        </div>
        ...
        <div className="flex flex-col justify-between text-sm">
          {callStats.map((item, index) => (
            <div key={index} className="flex flex-col mb-2">
              ...
              <span className="text-xs text-gray-400">Respon {item.label}</span>
...
export default SosialMediaSentimenCard;
