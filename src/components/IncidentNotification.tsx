...
const IncidentNotification = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 z-[9999] flex items-center justify-center">
      <div className="fixed bottom-10 right-5 z-50 bg-dashboard-accent p-4 rounded-xl text-white">
        ...
        />
        <button
          className="mt-2 text-sm bg-green-500 text-white rounded-md hover:bg-gray-500 px-2 py-2 w-full"
          onClick={dismissPopupIncident}
        >
          Clear
        </button>
        <button
          className="mt-2 text-sm bg-red-500 text-white rounded-md hover:bg-gray-500 px-2 py-2 w-full"
